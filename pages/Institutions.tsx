            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                ...
                <div className="flex gap-2 w-full md:w-auto">
                    <div className="relative flex-1 md:w-64">
                        {/* CORREÇÃO DO INPUT: Adicionado bg-white e text-slate-800 explicitamente */}
                        <input 
                            type="text" 
                    ...
                    <Button onClick={() => { setEditing({}); setIsModalOpen(true); }} className="shrink-0"><Icons.Plus /> Nova</Button>
                </div>
            </div>
